    ...
    for index, row in db_data.iterrows():
        ...
        (row.forecast_commit3 != 0 and row.forecast_commit3_date is not None) or (row.forecast_commit4 != 0 and row.forecast_commit4_date is not None):
            ...
            if id_found==[]:
                ...
                commit1_old_value,commit1,commit1_date,commit1_week,commit1_year,commit1_accepted,commit1_irp_processed,
                commit2_old_value,commit2,commit2_date,commit2_week,commit2_year,commit2_accepted,commit2_irp_processed,
                commit3_old_value,commit3,commit3_date,commit3_week,commit3_year,commit3_accepted,commit3_irp_processed,
                commit4_old_value,commit4,commit4_date,commit4_week,commit4_year,commit4_accepted,commit4_irp_processed,
                ...
                col = [commit1_date,commit1_week,commit1_year,commit2_date,commit2_week,commit2_year,commit3_date,commit3_week,commit3_year,commit4_date,commit4_week,commit4_year,\
